...
hi IncSearch       guifg=white guibg=darkblue gui=bold,italic
...
if s:molokai_original == 1
   ...
   hi LineNr          guifg=#465457 guibg=bg gui=italic,bold
...
if &t_Co > 255
   ...
   if has("spell")
       hi SpellBad                ctermbg=52 cterm=underline,italic
   ...
   hi LineNr          ctermfg=250 ctermbg=236 cterm=italic
   ...
   if exists("g:rehash256") && g:rehash256 == 1
       ...
       hi TabLine         ctermfg=4   ctermbg=233 cterm=none
       hi TabLineSel      ctermfg=12  ctermbg=none cterm=bold
